...
cd('C:\lighGMB_window10_normal\SET50\ADVANC');
...
[~, ~, advanc_data] = xlsread('C:\lighGMB_window10_normal\SET50\ADVANC\backtest_results_iter0.xlsx', 'BacktestData');
...
cd('C:\lighGMB_window10_normal\SET50\AOT');
...
[~, ~, aot_data] = xlsread('C:\lighGMB_window10_normal\SET50\AOT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = aot_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\BANPU');
...
[~, ~, banpu_data] = xlsread('C:\lighGMB_window10_normal\SET50\BANPU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\BBL');
...
[~, ~, bbl_data] = xlsread('C:\lighGMB_window10_normal\SET50\BBL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bbl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\BEM');
...
[~, ~, bem_data] = xlsread('C:\lighGMB_window10_normal\SET50\BEM\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bem_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\BDMS');
...
[~, ~, bdms_data] = xlsread('C:\lighGMB_window10_normal\SET50\BDMS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bdms_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\BH');
...
[~, ~, bh_data] = xlsread('C:\lighGMB_window10_normal\SET50\BH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\BTS');
...
[~, ~, bts_data] = xlsread('C:\lighGMB_window10_normal\SET50\BTS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bts_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\CBG');
...
[~, ~, cbg_data] = xlsread('C:\lighGMB_window10_normal\SET50\CBG\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cbg_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\CENTEL');
...
[~, ~, centel_data] = xlsread('C:\lighGMB_window10_normal\SET50\CENTEL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\COM_7');
...
[~, ~, com7_data] = xlsread('C:\lighGMB_window10_normal\SET50\COM_7\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = com7_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\CPALL');
...
[~, ~, cpall_data] = xlsread('C:\lighGMB_window10_normal\SET50\CPALL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\CPF');
...
[~, ~, cpf_data] = xlsread('C:\lighGMB_window10_normal\SET50\CPF\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpf_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\CPN');
...
[~, ~, cpn_data] = xlsread('C:\lighGMB_window10_normal\SET50\CPN\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpn_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\DELTA');
...
[~, ~, delta_data] = xlsread('C:\lighGMB_window10_normal\SET50\DELTA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\EA');
...
[~, ~, ea_data] = xlsread('C:\lighGMB_window10_normal\SET50\EA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ea_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\EGCO');
...
[~, ~, egco_data] = xlsread('C:\lighGMB_window10_normal\SET50\EGCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = egco_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\GLOBAL');
...
[~, ~, global_data] = xlsread('C:\lighGMB_window10_normal\SET50\GLOBAL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\GPSC');
...
[~, ~, gpsc_data] = xlsread('C:\lighGMB_window10_normal\SET50\GPSC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = gpsc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\HMPRO');
...
[~, ~, hmpro_data] = xlsread('C:\lighGMB_window10_normal\SET50\HMPRO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\INTUCH');
...
[~, ~, intuch_data] = xlsread('C:\lighGMB_window10_normal\SET50\INTUCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\IVL');
...
[~, ~, ivl_data] = xlsread('C:\lighGMB_window10_normal\SET50\IVL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ivl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\KBANK');
...
[~, ~, kbank_data] = xlsread('C:\lighGMB_window10_normal\SET50\KBANK\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\KTC');
...
[~, ~, ktc_data] = xlsread('C:\lighGMB_window10_normal\SET50\KTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\KTB');
...
[~, ~, ktb_data] = xlsread('C:\lighGMB_window10_normal\SET50\KTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\LH');
...
[~, ~, lh_data] = xlsread('C:\lighGMB_window10_normal\SET50\LH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = lh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\MTC');
...
[~, ~, mtc_data] = xlsread('C:\lighGMB_window10_normal\SET50\MTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mtc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\MINT');
...
[~, ~, mint_data] = xlsread('C:\lighGMB_window10_normal\SET50\MINT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mint_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\PTTGC');
...
[~, ~, pttgc_data] = xlsread('C:\lighGMB_window10_normal\SET50\PTTGC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\PTT');
...
[~, ~, ptt_data] = xlsread('C:\lighGMB_window10_normal\SET50\PTT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ptt_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\PTTEP');
...
[~, ~, pttep_data] = xlsread('C:\lighGMB_window10_normal\SET50\PTTEP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\RATCH');
...
[~, ~, ratch_data] = xlsread('C:\lighGMB_window10_normal\SET50\RATCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\SAWAD');
...
[~, ~, sawad_data] = xlsread('C:\lighGMB_window10_normal\SET50\SAWAD\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\SCC');
...
[~, ~, scc_data] = xlsread('C:\lighGMB_window10_normal\SET50\SCC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = scc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\TTB');
...
[~, ~, ttb_data] = xlsread('C:\lighGMB_window10_normal\SET50\TTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ttb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\TISCO');
...
[~, ~, tisco_data] = xlsread('C:\lighGMB_window10_normal\SET50\TISCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('C:\lighGMB_window10_normal\SET50\TOP');
...
[~, ~, top_data] = xlsread('C:\lighGMB_window10_normal\SET50\TOP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = top_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\TU');
...
[~, ~, tu_data] = xlsread('C:\lighGMB_window10_normal\SET50\TU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = tu_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('C:\lighGMB_window10_normal\SET50\WHA');
...
[~, ~, wha_data] = xlsread('C:\lighGMB_window10_normal\SET50\WHA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = wha_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
all_window10_normal_avg=all_window10_normal/39 
   ...
   %all_crash_avg  =(all_window10_crash_avg+all_window10_normal_avg+all_window10_normal_avg)/3
