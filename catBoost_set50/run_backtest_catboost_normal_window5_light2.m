...
[~, ~, advanc_data] = xlsread('D:\CatBoost\SET50\ADVANC\backtest_results_iter0.xlsx', 'BacktestData');
...
[~, ~, aot_data] = xlsread('D:\CatBoost\SET50\AOT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = aot_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, banpu_data] = xlsread('D:\CatBoost\SET50\BANPU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, bbl_data] = xlsread('D:\CatBoost\SET50\BBL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bbl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, bem_data] = xlsread('D:\CatBoost\SET50\BEM\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bem_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, bdms_data] = xlsread('D:\CatBoost\SET50\BDMS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bdms_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, bh_data] = xlsread('D:\CatBoost\SET50\BH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, bts_data] = xlsread('D:\CatBoost\SET50\BTS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bts_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, cbg_data] = xlsread('D:\CatBoost\SET50\CBG\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cbg_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, centel_data] = xlsread('D:\CatBoost\SET50\CENTEL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, com7_data] = xlsread('D:\CatBoost\SET50\COM_7\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = com7_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, cpall_data] = xlsread('D:\CatBoost\SET50\CPALL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, cpf_data] = xlsread('D:\CatBoost\SET50\CPF\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpf_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, cpn_data] = xlsread('D:\CatBoost\SET50\CPN\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpn_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, delta_data] = xlsread('D:\CatBoost\SET50\DELTA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, ea_data] = xlsread('D:\CatBoost\SET50\EA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ea_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, egco_data] = xlsread('D:\CatBoost\SET50\EGCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = egco_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, global_data] = xlsread('D:\CatBoost\SET50\GLOBAL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, gpsc_data] = xlsread('D:\CatBoost\SET50\GPSC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = gpsc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, hmpro_data] = xlsread('D:\CatBoost\SET50\HMPRO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, intuch_data] = xlsread('D:\CatBoost\SET50\INTUCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, ivl_data] = xlsread('D:\CatBoost\SET50\IVL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ivl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, kbank_data] = xlsread('D:\CatBoost\SET50\KBANK\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, ktc_data] = xlsread('D:\CatBoost\SET50\KTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, ktb_data] = xlsread('D:\CatBoost\SET50\KTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, lh_data] = xlsread('D:\CatBoost\SET50\LH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = lh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, mtc_data] = xlsread('D:\CatBoost\SET50\MTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mtc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, mint_data] = xlsread('D:\CatBoost\SET50\MINT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mint_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, pttgc_data] = xlsread('D:\CatBoost\SET50\PTTGC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, ptt_data] = xlsread('D:\CatBoost\SET50\PTT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ptt_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, pttep_data] = xlsread('D:\CatBoost\SET50\PTTEP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, ratch_data] = xlsread('D:\CatBoost\SET50\RATCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, sawad_data] = xlsread('D:\CatBoost\SET50\SAWAD\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, scc_data] = xlsread('D:\CatBoost\SET50\SCC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = scc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, ttb_data] = xlsread('D:\CatBoost\SET50\TTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ttb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, tisco_data] = xlsread('D:\CatBoost\SET50\TISCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
[~, ~, top_data] = xlsread('D:\CatBoost\SET50\TOP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = top_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, tu_data] = xlsread('D:\CatBoost\SET50\TU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = tu_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
[~, ~, wha_data] = xlsread('D:\CatBoost\SET50\WHA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = wha_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
