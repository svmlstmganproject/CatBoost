...
cd('D:\CatBoost\window5\SET50\ADVANC');
...
[~, ~, advanc_data] = xlsread('D:\CatBoost\window5\SET50\ADVANC\backtest_results_iter0.xlsx', 'BacktestData');
...
cd('D:\CatBoost\window5\SET50\AOT');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, aot_data] = xlsread('D:\CatBoost\window5\SET50\AOT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = aot_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\BANPU');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, banpu_data] = xlsread('D:\CatBoost\window5\SET50\BANPU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\BBL');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, bbl_data] = xlsread('D:\CatBoost\window5\SET50\BBL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bbl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\BEM');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, bem_data] = xlsread('D:\CatBoost\window5\SET50\BEM\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bem_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\BDMS');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, bdms_data] = xlsread('D:\CatBoost\window5\SET50\BDMS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bdms_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\BH');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, bh_data] = xlsread('D:\CatBoost\window5\SET50\BH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\BTS');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, bts_data] = xlsread('D:\CatBoost\window5\SET50\BTS\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = bts_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\CBG');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, cbg_data] = xlsread('D:\CatBoost\window5\SET50\CBG\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cbg_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\CENTEL');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, centel_data] = xlsread('D:\CatBoost\window5\SET50\CENTEL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\COM_7');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, com7_data] = xlsread('D:\CatBoost\window5\SET50\COM_7\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = com7_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\CPALL');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, cpall_data] = xlsread('D:\CatBoost\window5\SET50\CPALL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\CPF');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, cpf_data] = xlsread('D:\CatBoost\window5\SET50\CPF\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpf_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\CPN');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, cpn_data] = xlsread('D:\CatBoost\window5\SET50\CPN\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = cpn_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\DELTA');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, delta_data] = xlsread('D:\CatBoost\window5\SET50\DELTA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\EA');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ea_data] = xlsread('D:\CatBoost\window5\SET50\EA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ea_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\EGCO');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, egco_data] = xlsread('D:\CatBoost\window5\SET50\EGCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = egco_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\GLOBAL');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, global_data] = xlsread('D:\CatBoost\window5\SET50\GLOBAL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\GPSC');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, gpsc_data] = xlsread('D:\CatBoost\window5\SET50\GPSC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = gpsc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\HMPRO');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, hmpro_data] = xlsread('D:\CatBoost\window5\SET50\HMPRO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\INTUCH');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, intuch_data] = xlsread('D:\CatBoost\window5\SET50\INTUCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\IVL');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ivl_data] = xlsread('D:\CatBoost\window5\SET50\IVL\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ivl_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\KBANK');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, kbank_data] = xlsread('D:\CatBoost\window5\SET50\KBANK\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\KTC');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ktc_data] = xlsread('D:\CatBoost\window5\SET50\KTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\KTB');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ktb_data] = xlsread('D:\CatBoost\window5\SET50\KTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ktb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\LH');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, lh_data] = xlsread('D:\CatBoost\window5\SET50\LH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = lh_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\MTC');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, mtc_data] = xlsread('D:\CatBoost\window5\SET50\MTC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mtc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\MINT');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, mint_data] = xlsread('D:\CatBoost\window5\SET50\MINT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = mint_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\PTTGC');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, pttgc_data] = xlsread('D:\CatBoost\window5\SET50\PTTGC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\PTT');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ptt_data] = xlsread('D:\CatBoost\window5\SET50\PTT\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ptt_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\PTTEP');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, pttep_data] = xlsread('D:\CatBoost\window5\SET50\PTTEP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\RATCH');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ratch_data] = xlsread('D:\CatBoost\window5\SET50\RATCH\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\SAWAD');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, sawad_data] = xlsread('D:\CatBoost\window5\SET50\SAWAD\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\SCC');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, scc_data] = xlsread('D:\CatBoost\window5\SET50\SCC\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = scc_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\TTB');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, ttb_data] = xlsread('D:\CatBoost\window5\SET50\TTB\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = ttb_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\TISCO');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, tisco_data] = xlsread('D:\CatBoost\window5\SET50\TISCO\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
...
cd('D:\CatBoost\window5\SET50\TOP');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, top_data] = xlsread('D:\CatBoost\window5\SET50\TOP\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = top_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\TU');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, tu_data] = xlsread('D:\CatBoost\window5\SET50\TU\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = tu_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
...
cd('D:\CatBoost\window5\SET50\WHA');
[status, result] = system('python test_cat3.py');
if status == 0
...
[~, ~, wha_data] = xlsread('D:\CatBoost\window5\SET50\WHA\backtest_results_iter0.xlsx', 'BacktestData');
% Find the column index for 'cum_strategy_return'
headers = wha_data(1, :);
cum_strategy_return_idx = find(strcmp(headers, 'cum_strategy_return'));
% Extract the data from the cum_strategy_return column (skip header row)
